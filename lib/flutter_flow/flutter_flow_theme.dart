...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFE50606);
  Color secondaryColor = const Color(0xFF087640);
  Color tertiaryColor = const Color(0xFFFFFFFF);
  Color alternate = const Color(0xFF087640);
  Color primaryBackground = const Color(0xFFDAD3D3);
  Color secondaryBackground = const Color(0xDA595151);
  Color primaryText = const Color(0xFF0E0303);
  Color secondaryText = const Color(0xFF100F0F);

  Color primaryBtnText = Color(0xFFFFFFFF);
  Color lineColor = Color(0xFFE0E3E7);
  Color customColor1 = Color(0xFF1BA55C);
